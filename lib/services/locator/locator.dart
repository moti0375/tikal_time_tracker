...
Future setTimeTrackerApi() async {
  ...
  TimeRecordsRepository timeRecordsRepository = TimeRecordsRepository(remoteDateSource: RemoteDateSource(locator<DioNetworkAdapter>(), parser: locator<DomParser>()));
